...
suite = doctest.DocTestSuite(hl7conv)


class Testhl7convInputs(unittest.TestCase):
    ...
    def test_required_ref_build(self):
        with self.assertRaises(Exception) as context:
            hl7conv.Converter(os.path.join(
    ...
    def test_valid_ref_build_37(self):
        o_vcf_2_hl7v2 = hl7conv.Converter(os.path.join(
            os.path.dirname(__file__), 'vcf_example1.vcf'), 'GRCh37')
        self.assertEqual(type(o_vcf_2_hl7v2), hl7conv.Converter)
    ...
    def test_conv_region_only(self):
        ...
        o_vcf_2_hl7v2 = hl7conv.Converter(
            os.path.join(
...
class TestTranslation(unittest.TestCase):
    ...
    def test_with_patient_id(self):
        self.maxDiff = None
        o_vcf_2_hl7v2 = hl7conv.Converter(os.path.join(os.path.dirname(
...
class TestLogger(unittest.TestCase):
    ...
    def test_logger_forks(self):
        ...
        # create logger
        general_logger = logging.getLogger('hl7conv.general')
        invalid_record_logger = logging.getLogger('hl7conv.invalidrecord')
...
suite.addTests(
    unittest.TestLoader().loadTestsFromTestCase(Testhl7convInputs))
