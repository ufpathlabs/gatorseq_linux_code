...
with open(CONFIG_FILE, 'r') as stream:
    try:
        ...
        print(exc)
        sys.exit()
CODE_ENV='ProdEnv'#script_path.split('/')[-2]
USER_NAME='SID'#os.environ['USER']
...
def generateAccessToken():
    response = requests.post(QCI_ACCESS_TOKEN_URL, {"grant_type": "client_credentials", "client_id": "bd7a1714af065a9219d6d31ea6a1da22", 
    "client_secret": "83c821283fb21969494bb205863e5211"},  {"content-type": "text/plain;charset=UTF-8"} )
    return ast.literal_eval(response.content.decode("utf-8"))
...
def main():
    ...
    try: 
        ...
        print(" Could not open file! Please close Excel: ", GATOR_SEQ_SAMPLE_INPUT_FILE)
        sys.exit()
    try:
